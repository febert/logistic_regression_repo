...
from log_reg_from_tutorial_mod import load_data
...
def cg_optimization_mnist(n_epochs=100, mnist_pkl_gz='mnist.pkl.gz'):
    ...
    best_w_b, fopt, funccalls, out_4, out_5 = scipy.optimize.fmin_cg(
        f=train_fn,
